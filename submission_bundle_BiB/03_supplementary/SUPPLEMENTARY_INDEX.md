...
| `multiview_leave_one_out.tsv` / `multiview_leave_one_out_bootstrap.tsv` | §3.7 | Per-seed leave-one-view-out model metrics, and their paired-bootstrap AUROC/AUPRC contrasts against the full model with the joint weight/ablation contribution verdict. |
